                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">CONSULTA GENERAL</h1>
                                    </div>
                                    <form action="actualizacion_campo.php" method="POST" class="user">
                                        <div class="form-group">
                                            <input type="text" name="orden" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Ingresar la orden...">
                                        </div>
