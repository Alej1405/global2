<?php
    ...
    //filtro por ciudad
    $ciudad = 'WHERE city= "GUAYAQUIL"';

    // seleccion de todos los campos de la base de datos 
    $query = "SELECT * FROM order_clients WHERE city = 'GUAYQUIL' ORDER BY created_at DESC; ";
    ...
    $t_ordenes = "SELECT COUNT(order_id) FROM order_clients WHERE city = 'GUAYAQUIL';";
...
<center><h1 class="titulo__pagina">RECEPCION GENERAL DE ORDENES QUITO</h1></center>
...
<div class="botones-fin">
    ...
    <div class="enlace--boton lectura">
        <a href="segundallamada.php" class="enlace">
            ...
            <ul class="pagination">
                <li>
                    <a href="ordenesGye.php?pagina=<?php echo $_GET['pagina']-1; ?>" >
                            Anterior
                    </a>
                </li>

                <?php for($i=0; $i<$paginas2; $i++): ?>
                    <li><a href="ordenesGye.php?pagina=<?php echo $i+1; ?>"><?php echo $i+1; ?></a></li>
                <?php endfor ?>

                <li><a href="ordenesGye.php?pagina=<?php echo $_GET['pagina']+1; ?>">siguiente</a></li>
            </ul>
...
<fieldset class="form2 consulta__tabla fijar">
    ...
    <div class="tabla_scroll">
        <?php 
            ...
            $ciudad = 'WHERE city= "GUAYAQUIL"';
            $query = "SELECT * FROM order_clients ${ciudad} LIMIT ${iniciar}, ${n_orden} ;";
            $resultado = mysqli_query($db3, $query);
        ?>
        <table class="tabla_scroll" >
            <div class="form__grupo">
                <input type="int" name="ciudad" id="ciudad" class="form__input" placeholder=" " value="">
                <label for="ciudad" class="form__label">FILTRAR POR CIUDAD</label>
