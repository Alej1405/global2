<?php 
    ...
    $errores = [];
            ...
            //variables para generar el historial 
            $carrier_name = "NO ASIGNADO";
            $delivery_at = null;
            $transport_type = "LOGISTA GC DE PROVINCIA";
            $observation = "COORDINACION Y EMPAQUETADO";
            $deleted_at = null;
                ...
                if(empty($errores)) {
                        ...
                        direccion, correo, telefono, metodoPago, estado, observacion, fecha_pago, fechaGest, resLlamada ) 
                        ...
                        '$nombres', '$cedula', '$direccion', '$correo', '$telefono', '$metodoPago', '$filtro', '$observacion', '$fecha_pago', '$fechaGest', '$resLlamada')";
                        ...
                        //Generar el historial captura de datos para despachos.
                            ...
                            VALUES ('$carrier_name', '$transport_type', '$status', '$observation', '$order_id', 
                            '$fechaGest', '$fechaGest' )";
