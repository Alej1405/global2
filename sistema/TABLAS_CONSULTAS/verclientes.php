...
<table class="form2 consulta__tabla">
    ...
    <thead>
        <tr>
            ...
            <th>num contacto</th>
            <th>correo</th>
            <th>Usuario Ecuapass</th>
            <th>contraseña ecuapass</th>
            <th>acciones</th>
        </tr>
    </thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $cliente['usecuapass']; ?></td>
            ...
            <td>
                ...
                <div class="accion__actualizar">
                    <a href="actcliente.php?id=<?php echo $cliente['id']; ?>" class="acciones__enlace">actualizar</a>
                </div>
            </td>
        </tr>
        <?php endwhile; ?>
