<?php 
    ...
    $query = "SELECT * FROM  proceso    INNER join cargas  ON proceso.idCarga = cargas.id 
                                        INNER JOIN cliente ON cliente.id = cargas.idCliente WHERE cargas.idCliente = 25 AND NOT proceso.despacho = ''";
...
<table class="form2 consulta__tabla">
    <h2 class="form__titulo titutlo__tabla">CONSIGNAR CARGAS GC-TRADE </h2>
    <p class="form__p form2--p">
        Recuerda que estas cargas son exclucivas de GC-TRADE.
    </p>
        ...
        <tr>
            ...
            <td>
                <div class="accion__actualizar">
                    <a href="despachar.php?id=<?php echo $cliente['nProceso']; ?>" class="acciones__enlace">CONSIGNAR</a>
                </div>
            </td>
        </tr>
        <?php endwhile; ?>
