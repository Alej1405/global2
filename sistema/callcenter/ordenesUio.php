<?php
    ...
    $t_ordenes = "SELECT COUNT(order_id) FROM order_clients WHERE city = 'QUITO';";
...
<div class="botones-fin">
    ...
    <div class="enlace--boton lectura">
        <a href="segundallamada.php" class="enlace">
            ...
            <ul class="pagination">
                <li>
                    <a href="ordenesUio.php?pagina=<?php echo $_GET['pagina']-1; ?>" >
                            Anterior
                    </a>
                </li>

                <?php for($i=0; $i<$paginas2; $i++): ?>
                    <li><a href="ordenesUio.php?pagina=<?php echo $i+1; ?>"><?php echo $i+1; ?></a></li>
                <?php endfor ?>

                <li><a href="ordenesUio.php?pagina=<?php echo $_GET['pagina']+1; ?>">siguiente</a></li>
            </ul>
