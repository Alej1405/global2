...
<title>GLOBAL CARGO EC</title>
    <meta name="description:" content="Sistema de gestion de operaciones">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../../sistema/CLIENTE/cliente.php">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3"><?php echo $_SESSION['cliente']; ?> <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../../sistema/CLIENTE/cliente.php">
            ...
            <!-- nav con condicional para ingresos de cargas -->
            <?php if ($_SESSION['cliente'] == "ronny") :?>
            <li class="nav-item">
                <a class="nav-link" href="nuevaOrden.php">
